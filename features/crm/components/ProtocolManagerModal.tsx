...
import { generateMessageTemplate } from '../../../lib/gemini';
...
const ProtocolManagerModal: React.FC<ProtocolManagerModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleAiGenerate = async () => {
      const topic = prompt("What is this message about? (e.g. 'Meeting follow up' or 'Birthday wish')");
      if (!topic) return;
      
      setIsGenerating(true);
      try {
          const content = await generateMessageTemplate(topic);
          const newId = `tpl_${Date.now()}`;
          const newTpl = { id: newId, label: topic, content: content };
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-2">
               ...
               <div className="flex gap-2">
                   ...
                   <Button variant="primary" size="sm" onClick={handleCreate}>＋ New</Button>
               </div>
            </div>
